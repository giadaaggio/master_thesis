...
class CMDRegionSelector:
    def __init__(self, data, color, magnitude, color_bound_bin, magnitude_bound_bin, color_bound_prim, magnitude_bound_prim, output_file="selected_regions.csv"):
        self.data = data
        self.color = color
    ...
    def init_plot(self):
        ...
        #self.ax.set_xlabel(f'{self.filter_x} - {self.filter_y}')
        #self.ax.set_ylabel(self.filter_y)
